...
&emsp;&emsp;若$$X\sim f(x)$$，则样本$$(X_1,X_2,…,X_n)\sim f(x_1,x_2,…,x_n)=\prod f(x_i)$$；  
&emsp;&emsp;若X是离散型的，分布律$$P(X=x)=p_i(x)$$，则$$(X_1=x_1,X_2=x_2,…,X_n=x_x)=\prod p(x_i)$$  
...
## 三大抽样分布  
统计量的分布叫抽样分布。它与样本分布不同，后者是指样本$$X_1,X_2,…,X_n$$的联合分布。  
